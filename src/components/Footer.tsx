import { NAV_LINKS, CLINIC_NAME, CLINIC_TAGLINE } from "@/lib/constants";

export default function Footer() {
  return (
    <footer className="bg-primary-900 py-12 text-primary-100">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div>
            ...
            >
              <span role="img" aria-label="Huella de mascota">
                🐾
              </span>
              {CLINIC_NAME}
            </a>
            <p className="mt-2 text-sm text-primary-300">{CLINIC_TAGLINE}</p>
          </div>
        ...
        <div className="mt-12 border-t border-primary-800 pt-8 text-center text-sm text-primary-400">
          <p>
            ...
            {CLINIC_TAGLINE}. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>
